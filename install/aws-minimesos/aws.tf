...
resource "aws_vpc" "terraform" {
  ...
  tags = {
    ...
    yor_trace = "c647b369-9e15-4cf2-b963-5c38fb401f3c"
  }
}
...
resource "aws_internet_gateway" "terraform" {
  ...
  tags = {
    ...
    git_org   = "RadoGar-Biz"
    git_repo  = "microservices-demo"
    yor_trace = "eb6a6b14-1b37-4b28-b578-d00631d38e4d"
  }
}
...
resource "aws_subnet" "terraform" {
  ...
  tags = {
    ...
    git_org   = "RadoGar-Biz"
    git_repo  = "microservices-demo"
    yor_trace = "f134e4c7-e6c8-4337-87fc-d55c1bdb1e38"
  }
}
...
resource "aws_route_table" "terraform" {
  ...
  tags = {
    ...
    git_org   = "RadoGar-Biz"
    git_repo  = "microservices-demo"
    yor_trace = "be3ec155-a305-4f83-963d-920b5fd48f62"
  }
}
...
resource "aws_security_group" "terraform" {
  ...
  tags = {
    ...
    git_org   = "RadoGar-Biz"
    git_repo  = "microservices-demo"
    yor_trace = "902041d7-59be-45b4-948c-36ee2638ede3"
  }
}
